<?php require_once('./inc/header.php'); ?>
		...
		<section id="content">
			...
			<section class="section page-heading animate-onscroll">
				<h1>Annual Sponsorship Breakfast</h1>
			</section>
			<!-- Page Heading -->
				...
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-8">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
								...
								<strong><h2>PARKING TIPS</h2></strong><br>The city of Kent has officers patrol the downtown area
								...
								There is more than ample parking at the Kent Station Plaza and we are only a 5-minute walk from the parking structure there. Please park wisely.
